...
CREATE TABLE emp4(
				  ...
				  id NUMBER(10),
				  NAME VARCHAR2(20) CONSTRAINT emp4_name_nn NOT NULL, --列级约束
				  email VARCHAR2(30),
...
CREATE TABLE emp5(
				  ...
				  NAME VARCHAR2(20) CONSTRAINT emp5_name_nn NOT NULL, --列级约束
				  email VARCHAR2(30),
				  salary NUMBER(10, 2) DEFAULT 1000, --默认约束
...
CREATE TABLE emp6(
				  ...
				  id NUMBER(10),
				  NAME VARCHAR2(20) CONSTRAINT emp6_name_nn NOT NULL, --列级约束
				  email VARCHAR2(30),
				  salary NUMBER(10, 2) DEFAULT 1000, --默认约束
...
CREATE TABLE emp7(
				  ...
				  id NUMBER(10),
				  NAME VARCHAR2(20) CONSTRAINT emp7_name_nn NOT NULL, --列级约束
				  email VARCHAR2(30),
				  salary        NUMBER(10, 2) DEFAULT 1000, --默认约束
...
--外键约束 --级联删除ON DELETE CASCADE --级联置空ON DELETE SET NULL
--列级约束
CREATE TABLE emp81(
				   
				   id NUMBER(10),
				   NAME VARCHAR2(20) CONSTRAINT emp8_name_nn NOT NULL, --列级约束
				   email VARCHAR2(30),
				   salary        NUMBER(10, 2) DEFAULT 1000, --默认约束
				   department_id NUMBER(10) references departments(department_id) ON DELETE SET NULL,
...
CREATE TABLE emp9(
				  ...
				  id NUMBER(10),
				  NAME VARCHAR2(20) CONSTRAINT emp9_name_nn NOT NULL, --列级约束
				  email VARCHAR2(30),
...
CREATE TABLE emp10(
				   ...
				   id NUMBER(10),
				   NAME VARCHAR2(20) CONSTRAINT emp10_name_nn NOT NULL, --列级约束
				   email VARCHAR2(30),
				   salary NUMBER(10,
...
ALTER TABLE emp10 modify(salary NUMBER(10,
								2) NOT NULL);

--添加其他约束
ALTER TABLE emp10 add CONSTRAINT emp10_email_uk UNIQUE(email);
...
*/
ALTER TABLE emp10 drop CONSTRAINT emp10_email_uk;
...
--练习：57. 定义非空约束
--  1). 非空约束只能定义在列级.
CREATE TABLE emp11(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20));
--  2). 不指定约束名
ALTER TABLE emp11 modify(salary NUMBER(10) NOT NULL);
--  3). 指定约束名 
ALTER TABLE emp11 modify(NAME VARCHAR2(20) CONSTRAINT emp11_name_nn NOT NULL);

--练习：58. 唯一约束
--  1). 列级定义
--      ①. 不指定约束名
CREATE TABLE emp12(id NUMBER(10),
				   NAME VARCHAR2(20) UNIQUE,
				   salary NUMBER(10),
				   email VARCHAR2(20));
--      ②. 指定约束名
CREATE TABLE emp13(id NUMBER(10),
				   NAME VARCHAR2(20) CONSTRAINT emp13_name_uk UNIQUE,
				   salary NUMBER(10),
				   email VARCHAR2(20));
--  2). 表级定义: 必须指定约束名
--      ①. 指定约束名
CREATE TABLE emp14(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
				   CONSTRAINT emp14_name_uk UNIQUE(NAME));
--练习：58.1 主键约束：唯一确定一行记录。表明此属性：非空，唯一 
CREATE TABLE emp15(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
...
--  1). 列级定义
--      ①. 不指定约束名
CREATE TABLE emp16(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
				   dept_id NUMBER(10) references departments(department_id));
--      ②. 指定约束名
CREATE TABLE emp17(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
...
--  2). 表级定义: 必须指定约束名
--      ①. 指定约束名
CREATE TABLE emp18(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
				   dept_id NUMBER(10),
...
--  1). 级联删除:
CREATE TABLE emp19(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
...
--  2). 级联置空：
CREATE TABLE emp20(id NUMBER(10),
				   NAME VARCHAR2(20),
				   salary NUMBER(10),
				   email VARCHAR2(20),
				   dept_id NUMBER(10),
...
ALTER TABLE emp2 drop column dept_id;
...
--可以省略括号
ALTER TABLE emp2 add dept_id NUMBER(10) CONSTRAINT my_emp_dept_id_fk references dept2(id);

-- 可以省略类型，默认会与外键类型一样(列级约束)。
ALTER TABLE emp2 add dept_id CONSTRAINT my_emp_dept_id_fk references dept2(id);
