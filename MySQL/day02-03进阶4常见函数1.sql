...
*/
SELECT INSTR('杨不悔爱上了殷黎亭','殷黎亭') out_put;
/*
...
*/
SELECT STR_TO_DATE('1989-10-19','%Y-%m-%d') 日期;
/*
...
*/
SELECT last_name,
	   (hiredate, '%m月/%d日 %y年') 入职日期
	FROM employees
	WHERE commission_pct IS NOT NULL;
SELECT DATE_FORMAT('2018/06/06','%Y年%m月%d日') 日期;
/*
        四、其他函数
